      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Lucky Deals maintains the highest standards of security, fairness, and transparency. Our certifications and
            affiliations demonstrate our commitment to providing a safe and trustworthy platform.
          </p>
        </div>
        ...
        {/* Security Features */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Security & Privacy</h2>
        ...
        {/* Affiliations */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Our Affiliations</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-white mb-1">{affiliation.name}</h3>
                      <p className="text-purple-300 text-sm mb-1">{affiliation.role}</p>
                      <p className="text-gray-500 text-xs">Member since {affiliation.since}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <CardContent className="prose prose-gray max-w-none">
            <div className="text-center space-y-4">
              <p className="text-gray-400 leading-relaxed">
                At Lucky Deals, trust is the foundation of everything we do. We understand that when you participate in
                our lotteries, you're placing your faith in our platform, our processes, and our commitment to fairness.
              </p>
              <p className="text-gray-400 leading-relaxed">
                That's why we've invested heavily in obtaining the most rigorous certifications, partnering with
                respected industry organizations, and implementing cutting-edge security measures. Every draw is
                conducted under strict supervision, every winner is verified, and every transaction is protected.
              </p>
              <p className="text-gray-400 leading-relaxed">
                Our certifications aren't just badges on our website – they represent our ongoing commitment to
                maintaining the highest standards of integrity, security, and fairness in everything we do.
              </p>
            </div>
          </CardContent>
        </Card>
