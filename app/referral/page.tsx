...
const referralTiers = [
  ...
  },
  {
    ...
    bonus: "7.50",
    color: "bg-gray-400",
    benefits: ["7.50 per referral", "Priority support"],
  },
  {
    name: "Gold",
    minReferrals: 25,
...
export default function ReferralPage() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Join Lucky D&D",
          text: "Join me on Lucky D&D and get a chance to win amazing prizes!",
          url: referralLink,
        });
      } catch (err) {
  ...
  const nextTier = referralTiers.find(
    (tier) => tier.minReferrals > userData.totalReferrals
  );
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Invite your friends to Lucky D&D and earn rewards for every
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-purple-700 to-violet-800"
              >
            ...
            {referralTiers.map((tier, index) => (
              ...
              >
                ...
                <CardHeader className="text-center">
                  <div
                    className={`mx-auto w-16 h-16 ${tier.color} rounded-full flex items-center justify-center mb-4`}
                  >
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">
                    {userData.totalReferrals} / {nextTier.minReferrals}{" "}
                    referrals
                  </span>
                  <span className="text-gray-400">
                    {nextTier.minReferrals - userData.totalReferrals} more
                    needed
                  </span>
                </div>
                <div className="w-full bg-slate-700 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${
                        (userData.totalReferrals / nextTier.minReferrals) * 100
                      }%`,
                    }}
                  ></div>
                </div>
